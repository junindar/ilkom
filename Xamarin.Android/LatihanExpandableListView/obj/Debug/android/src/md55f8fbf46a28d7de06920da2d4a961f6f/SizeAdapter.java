package md55f8fbf46a28d7de06920da2d4a961f6f;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("LatihanExpandableListView.SizeAdapter, LatihanExpandableListView, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", SizeAdapter.class, __md_methods);
	}
	...
	public SizeAdapter ()
	{
		...
		if (getClass () == SizeAdapter.class)
			mono.android.TypeManager.Activate ("LatihanExpandableListView.SizeAdapter, LatihanExpandableListView, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
